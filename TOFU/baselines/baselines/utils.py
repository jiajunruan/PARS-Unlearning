...
def load_model_and_tokenizer(
    ...
    # If tokenizer_dir is not provided, default to model_dir so we load the
    # tokenizer that accompanies the model by default (useful for HF model ids).
    tk_dir = tokenizer_dir if tokenizer_dir is not None else model_dir
    tokenizer = load_tokenizer(tk_dir, add_pad_token) if tk_dir is not None else None
